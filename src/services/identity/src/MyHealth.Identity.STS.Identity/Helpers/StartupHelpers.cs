...
using SendGrid;
using MyHealth.Identity.Shared.Configuration.Email;
using MyHealth.Identity.Shared.Email;
using MyHealth.Identity.STS.Identity.Configuration;
using MyHealth.Identity.STS.Identity.Configuration.ApplicationParts;
...
using MyHealth.Identity.STS.Identity.Helpers.Localization;
using System.Linq;
...
using MyHealth.Identity.Shared.Authentication;
