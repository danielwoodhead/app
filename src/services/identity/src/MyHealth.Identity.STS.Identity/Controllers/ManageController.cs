...
using MyHealth.Identity.STS.Identity.ViewModels.Manage;

namespace MyHealth.Identity.STS.Identity.Controllers
{    
    [Authorize]
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("MyHealth.Identity.STS.Identity"),
