...
locals {
  app_service_name  = "${var.prefix}-admin-api"
...
resource "azurerm_app_service" "as" {
  ...
  app_settings = {
    ...
    AdminApiConfiguration__ApiBaseUrl            = "https://${local.app_service_name}.azurewebsites.net"
    AdminApiConfiguration__IdentityServerBaseUrl = var.identity_server_base_url
    AdminApiConfiguration__OidcApiName           = "myhealth-identity-api"
  }
}
